...
const EventForm: React.FC<EventFormProps> = ({ event, onSubmit, onCancel, onDelete }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        try {
            // Combinando a data e hora para data de início
            ...
            // Se a data de término estiver habilitada, combinar data e hora de término
    ...
    const toggleEndDate = () => {
        ...
        if (!endDateEnabled && !endTime) {
            // Se estiver habilitando, definir um horário de fim padrão (1h após início)
            ...
            <div className="calendar-event-form-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="calendar-form-actions">
                        ...
                        {onDelete && (
                            <button type="button" className="calendar-delete-btn" onClick={onDelete}>
                                Excluir
                            </button>
                        )}
                    </div>
